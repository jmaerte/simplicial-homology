...
### Approach 1: GCD
You can read about gcd based smith normal form algorithm and its problems <a href="http://docdro.id/a8pirOS" target="_blank">here</a>.
### Approach 2: Modulo
This is the (for now) final algorithm I used in code. It is described <a href="http://docdro.id/Dbv2XcQ" target="_blank">here</a>.
